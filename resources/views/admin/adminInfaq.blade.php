...
<html lang="en">
    ...
    @else
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="ml-5">
                    <p class="h1 mt-5" style="font-size: 35px">Infaq</p>
                    <p class="h5 mt-3" style="font-size: 20px">
                        Berikut merupakan data pengguna yang melakukan Infaq,
                        silahkan tekan tombol acc untuk melakukan verifikasi
                        apakah uang sudah masuk atau belum
                    </p>
                    <table class="table table-hover mt-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="/konfirmasiInfaq/{{ $data->id_infaq }}"
                                        >Konfirmasi Infaq</a
                                    >
                                </td>
                            </tr>
