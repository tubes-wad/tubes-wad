...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" id="banner">
            <p class="h1" style="font-size: 35px">Lazissu</p>
            ...
            <div class="row mt-4 mb-4">
                ...
                >
                    ...
                    <a class="btn btn-primary mt-2 mb-3" href="">Infaq</a>
                </div>
                <div
                    class="col shadow mr-3"
                    style="
                ...
                >
                    <center>
                        <p class="h1 mt-4" style="font-size: 30px">Beasiswa</p>
                    </center>
                    <p class="h3 mt-4" style="font-size: 15px">
                        Yuk bantu mahasiswa berprestasi untuk menggapai
                        cita-citanya! LAZISSU memberikan bantuan untuk para
                        mahasiswa berprestasi demi kelancaran belajarnya di
                        kampus lho!
                    </p>
                    <a class="btn btn-primary" href="">Beasiswa</a>
                </div>
                <div
                    class="col shadow"
                    style="
                ...
                >
                    ...
                    <a class="mt-3 btn btn-primary" href="">Waqaf</a>
                </div>
            </div>
        </div>
